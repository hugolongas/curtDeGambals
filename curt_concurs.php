<?php
	...
	$consulta = "SELECT * FROM curtdegambals_control_vots WHERE ip_ordinador LIKE '$usuario' ORDER BY dia_vot ASC;";
	...
	$consulta = "SELECT * FROM curtdegambals_concurs WHERE (titol LIKE '%".$titol_curt."%' && director LIKE '%".$director_curt."%') and edicio = 7 ORDER BY titol ASC;";
